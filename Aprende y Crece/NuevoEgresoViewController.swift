//
//  NuevoEgresoViewController.swift
//  Aprende y Crece
//
...
class NuevoEgresoViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate, FSCalendarDataSource, FSCalendarDelegate {
    ...
    override func viewDidLoad() {
        ...
        // TEXTFIELD
        motivoTextfield.addTarget(self, action: #selector(NuevoEgresoViewController.motivoTextfieldAccion(_:)), forControlEvents: UIControlEvents.TouchDown)
...
//        view.addGestureRecognizer(tap)
    ...
    func insertarEgreso() {
        ...
        dispatch_async(dispatch_get_main_queue()) { () -> Void in
            JHProgressHUD.sharedHUD.showInView(self.view, withHeader: "Guardando Egreso", andFooter: "Por favor espere...")
        }
        
        
        var egreso = montoTextview.text
        ...
        egreso = egreso.stringByAddingPercentEncodingWithAllowedCharacters(customAllowedSet)!
        ...
        let urlString = "http://intercubo.com/aprendeycrece/api/insertarMontos.php?idUsuario=" + id + "&monto=" + egreso + "&motivo=" + motivo + "&fecha=" + fecha + "&descripcion=" + descripcion + "&repetir=" + repetirGasto + "&tipo=e"
                    ...
                    do {
                        ...
                        if jsonResponse.count > 0 {
                            ...
                            dispatch_async(dispatch_get_main_queue(), { () -> Void in
                                ...
                                alertView.showSuccess("Aprende y Crece", subTitle: "Se ha guardado su egreso exitosamente")
